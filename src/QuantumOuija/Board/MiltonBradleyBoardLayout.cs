...
public static class MiltonBradleyBoardLayout
{
    public static BoardModel Create(int boardWidth, int boardHeight, int gridSpacingPixels)
    {
        ...
        AddRectangle(regions, "goodbye", new BoardToken(RegionType.Goodbye, "GOODBYE"), 0.345f, 0.785f, 0.310f, 0.100f, boardWidth, boardHeight, 100);

        AddTokenRow(regions, "letters-row-1", "ABCDEFGHIJKLM", 0.172f, 0.828f, 0.335f, 0.047f, 0.080f, boardWidth, boardHeight, RegionType.Letter, 50);
        AddTokenRow(regions, "letters-row-2", "NOPQRSTUVWXYZ", 0.172f, 0.828f, 0.465f, 0.047f, 0.080f, boardWidth, boardHeight, RegionType.Letter, 50);
        AddTokenRow(regions, "numbers", "1234567890", 0.260f, 0.740f, 0.615f, 0.047f, 0.080f, boardWidth, boardHeight, RegionType.Number, 50);
